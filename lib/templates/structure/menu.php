...
add_action( 'wp', 'ehc_set_up_menu_structure' );
/**
 ...
 * @return void
 */
function ehc_set_up_menu_structure() {
...
add_action( 'beans_header_after_markup', 'ehc_move_nav_under_header' );
/**
 ...
 * @return void
 */
function ehc_move_nav_under_header() {
	echo beans_open_markup( 'ehc_primary_nav', 'div', array( 'class' => 'pp-primary-nav' ) );
	?>
    <div class="uk-container uk-container-center">
		<?php echo beans_primary_menu(); ?>
    </div>
	<?php
	echo beans_close_markup( 'ehc_primary_nav', 'div' );
}
